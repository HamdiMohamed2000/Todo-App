...
@AndroidEntryPoint
class TasksFragment : Fragment(R.layout.fragment_tasks), TasksAdapter.onItemClickLisener {
    ...
    override fun onChekBoxClick(task: Task, isChecked: Boolean) {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        val pandingQuery = viewModel.searchQuery.value
        if (pandingQuery != null && pandingQuery.isNotEmpty()) {
            searchItem.expandActionView()
            searchView.setQuery(pandingQuery,false)
        }
